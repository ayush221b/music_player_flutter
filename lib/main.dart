...
import 'package:music_player_ayush/bottom_controls.dart';
  ...
  void _renderHistogram(Canvas canvas, Size size, List<int> histogram) {
    ...
    for(int i = 2; i < points.length - 4; i+=2) {
      ...
      path.cubicTo(
        ...
        points[i - 2] + 5.0, points[i-1],
        points[i] - 5.0, points[i+1],
        points[i], points[i+1]
      );
    }
...
class _RadialProgressBarState extends State<RadialProgressBar> {
  EdgeInsets _insetsForPainter() {
    /*Make space for the painted track, progress and thumb. we divide by 2.0,
    ...
    return Padding(
      ...
      child: new CustomPaint(
        foregroundPainter: new RadialProgressBarPainter(
            ...
            progressColor: widget.trackColor,
